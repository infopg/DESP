...
function bar32(mychart,a){
    option = {
        color:['#FFAE57'],
        title: {
            text: '2017年排名前10研究单位情况',
            left: 'center',
            textStyle: {
                color: '#333333',
                fontSize:'130%'
...
function map3(chart, rad, a) {
    ...
    var geoCoordMap = {
        ...
        "上海药物研究所":[121.45947152986486,31.19921852534572],
        "上海有机化学研究所":[121.46340727579572,31.198358427176935],
            ...
            $.get('/static/DATA/overview_yjs.json').done(function(data) {
                ...
                for (var i = 0; i < data.name17.length; i++) {
                    if (data.name17[i] == provinceName) {
                        optionR = {
                            title: {
                                text: '2017年' + provinceName + '9项指标平均成绩',
                                x: 'center', //水平位置：居中
                                y: 'bottom', //垂直位置：底部
                                textStyle: {
                                    color: '#333333',
