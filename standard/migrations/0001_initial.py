    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('table_evaluation_indicator_col_parent_name', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='standard.TableEvaluationIndicator', verbose_name='父部门')),
            ],
            options={
